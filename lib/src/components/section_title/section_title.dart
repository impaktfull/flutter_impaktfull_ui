...
class ImpaktfullUiSectionTitle extends StatelessWidget with ComponentDescriptorMixin {
  final String title;
  ...
  Widget build(BuildContext context) {
    return ImpaktfullUiComponentThemeBuidler<ImpaktfullUiSectionTitleTheme>(
      ...
      builder: (context, componentTheme) {
        ...
        return Padding(
          padding: margin ??
              (areAllIconButtons ? componentTheme.dimens.marginWithIconButtonActions : componentTheme.dimens.margin),
