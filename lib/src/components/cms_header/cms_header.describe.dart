...
String _describeInstance(ImpaktfullUiCmsHeader instance) {
  final sb = StringBuffer();
  sb.write('title: ${instance.title} / ');
  if (instance.subtitle != null) sb.write('subtitle: ${instance.subtitle} / ');
  if (instance.onBackTapped != null) sb.write('onBackTapped: ${instance.onBackTapped} / ');
  if (instance.actions.isNotEmpty) sb.write('actions: ${instance.actions.length} / ');
