...
void main() {
  ...
  // The shimmer repeats forever, so the skeletons are not frozen: they are
  // pumped to the middle of one sweep, where the highlight is visible.
  runComponentTest(
    ...
    pumpBeforeTest: (tester) async {
      await tester.pump();
      await tester
          .pump(const ImpaktfullUiSkeletonDurationsTheme().shimmer ~/ 2);
    },
    goldenTests: () => [
      GoldenTest(
        description: 'box',
