        ...
        child: ImpaktfullUiChat(
          senderConfig: const ImpaktfullUiChatSenderConfig.oneToOne(
            ...
            other: ImpaktfullUiChatSender(
              id: '1',
              name: 'Client',
              avatarUrl: NetworkImages.image16x9,
            ),
          ),
          isTyping: Stream.periodic(
              const Duration(seconds: 10), (value) => value.isEven),
          items: [
            ...
            ImpaktfullUiChatItem(
              message:
                  'No, I am on holiday, can we reschedule it for next week?',
              senderId: '2',
              isMyOwnMessage: true,
