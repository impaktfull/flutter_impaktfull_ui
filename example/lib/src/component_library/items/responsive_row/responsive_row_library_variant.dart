...
class ResponsiveRowLibraryVariant
    extends ComponentLibraryVariant<ResponsiveRowLibraryPrimaryInputs> {
  ...
  @override
  ResponsiveRowLibraryPrimaryInputs inputs() =>
      ResponsiveRowLibraryPrimaryInputs();
}
