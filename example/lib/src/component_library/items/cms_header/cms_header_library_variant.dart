    ...
    return [
      ...
      ImpaktfullUiCmsHeader(
        ...
        bottomChild: ImpaktfullUiHorizontalTabs(
          value: inputs.selectedTab.value,
          onChanged: inputs.selectedTab.updateState,
          tabs: [
            ImpaktfullUiHorizontalTabConfig(title: 'Tab 1', value: 0),
            ImpaktfullUiHorizontalTabConfig(title: 'Tab 2', value: 1),
            ImpaktfullUiHorizontalTabConfig(title: 'Tab 3', value: 2),
            ImpaktfullUiHorizontalTabConfig(title: 'Tab 4', value: 3),
            ImpaktfullUiHorizontalTabConfig(title: 'Tab 5', value: 4),
          ],
        ),
      ),
    ];
