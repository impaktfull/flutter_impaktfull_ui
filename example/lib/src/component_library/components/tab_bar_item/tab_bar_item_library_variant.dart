...
import 'package:impaktfull_ui_example/src/component_library/components/tab_bar_item/tab_bar_item_library_item.dart';
import 'package:impaktfull_ui_example/src/component_library/config/component_library_item.dart';

class TabBarItemLibraryVariant extends ComponentLibraryVariant<TabBarItemLibraryPrimaryInputs> {
  ...
  @override
  List<Widget> build(BuildContext context, TabBarItemLibraryPrimaryInputs inputs) {
    return [
