...
class RadioButtonLibraryVariant extends ComponentLibraryVariant<RadioButtonLibraryPrimaryInputs> {
  ...
  @override
  List<Widget> build(BuildContext context, RadioButtonLibraryPrimaryInputs inputs) {
    return [
