...
class NumberInputLibraryVariant extends ComponentLibraryVariant<NumberInputLibraryPrimaryInputs> {
  ...
  @override
  List<Widget> build(BuildContext context, NumberInputLibraryPrimaryInputs inputs) {
    return [
